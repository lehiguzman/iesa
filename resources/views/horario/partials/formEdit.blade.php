...
<div class="form-group form-inline justify-content-center col-sm-12">         
    <select id="tipo" name="tipo" class="form-control">
        ...
        <option value="1" @if($horario->tipo == '1') selected @endif>Diurno</option>
        <option value="2" @if($horario->tipo == '2') selected @endif>Nocturno</option>
        <option value="3" @if($horario->tipo == '3') selected @endif>Fin de Semana</option>
    </select>    
    @if ($errors->has('tipo'))
...
<div class="form-group form-inline justify-content-center col-sm-12">                  
    <input type="text" class="form-control-user form-control{{ $errors->has('lapso') ? ' is-invalid' : '' }} col-sm-4 text-center" id="lapso" name="lapso" value="{{ $horario->lapso }}" placeholder="Laspo del horario" required>
    @if ($errors->has('lapso'))
            <span class="invalid-feedback" role="alert">
